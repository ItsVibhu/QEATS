...
public interface RestaurantRepositoryService {
  ...
  CompletableFuture<List<Restaurant>> asyncFindRestaurantByName(Double latitude, 
      Double longitude, String searchString, LocalTime currentTime, Double servingRadiusInKms);

  CompletableFuture<List<Restaurant>> asynFindRestaurantByAttribute(Double latitude, 
      Double longitude, String searchString, LocalTime currentTime, Double servingRadiusInKms);

  CompletableFuture<List<Restaurant>> asynFindRestaurantByItemName(Double latitude, 
      Double longitude, String searchString, LocalTime currentTime, Double servingRadiusInKms);

  CompletableFuture<List<Restaurant>> asynFindRestaurantByItemAttribute(Double latitude, 
      Double longitude, String searchString, LocalTime currentTime, Double servingRadiusInKms);
